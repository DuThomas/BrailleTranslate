...
def resize_braille_char(braille_char, image):
    ...
    braille_char.width = max(braille_char.width, default_w)
    braille_char.height = max(braille_char.height, default_h) # character box =! points box (character box >= points box)
...
def create_braille_chars(point_groups, image):
    ...
    for point_group in point_groups:
        ...
        resize_braille_char(braille_char, image)
