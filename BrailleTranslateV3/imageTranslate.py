...
threshold_value = (brailleReaderV3.find_best_threshold(img, args.debug)
                   if args.auto
...
while True:
    ...
    thresholded_img = roiFinderV3.threshold_image(input_img, threshold_value)
    debug_img = thresholded_img.copy()

    braille_chars = brailleReaderV3.get_braille_chars(input_img,
                                                      debug_img,
                                                      args.debug)
    
    roiFinderV3.translate_braille_chars(thresholded_img, braille_chars)
